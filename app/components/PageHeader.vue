      ...
      <nav class="relative z-50 flex justify-between">
        <div class="flex items-center md:gap-x-12">
          ...
          /><path
            ...
            fill="#0F172A"
          /></svg></a><div class="hidden md:flex md:gap-x-6">
            <a
        ...
        </div><div class="flex items-center gap-x-5 md:gap-x-8">
          <DarkModeToggle />
          ...
          <a
            ...
            variant="solid"
            href="/register"
          ><span>Get started <span class="hidden lg:inline">today</span></span></a><div class="-mr-1 md:hidden">
